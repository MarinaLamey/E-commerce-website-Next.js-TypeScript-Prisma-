...
import MotionWrapper from "@/componant/MotionWrapper/MotionWrapper";
...
export const OffersSection = async ({ title, user, categoryId }: OffersSection) => {
  ...
  return (
    /* Note: We keep the main container here but the animation 
       logic will be handled by the Client Component or a Wrapper 
    */
    <MotionWrapper>
      <div 
